...
def post_west_first_round():
    ...
    west_first_round_1 = data['west_first'][0]
    west_first_round_2 = data['west_first'][1]
    west_first_round_3 = data['west_first'][2]
    west_first_round_4 = data['west_first'][3]
...
def post_east_first_round():
    data = request.get_json()
    east_first_round_1 = data['east_first'][0]
    east_first_round_2 = data['east_first'][1]
    east_first_round_3 = data['east_first'][2]
    east_first_round_4 = data['east_first'][3]
...
def post_west_semi_final():
    data = request.get_json()
    west_semi_final_1 = data['west_semi'][0]
    west_semi_final_2 = data['west_semi'][1]
...
def post_east_semi_final():
    data = request.get_json()
    east_semi_final_1 = data['east_semi'][0]
    east_semi_final_2 = data['east_semi'][1]
